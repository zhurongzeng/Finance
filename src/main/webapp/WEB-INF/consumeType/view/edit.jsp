...
<form id="consume_type_edit_form" method="post">
	<table align="center" style="border-collapse: separate; border-spacing: 15px 10px; margin-top: 25px;">
		<tr>
			<td><label>编码:</label></td>
			<td><input id="code" name="code" class="easyui-validatebox" data-options="validType:'maxLength[16]',required:true" readonly="readonly"/></td>
